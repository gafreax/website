...
import { Github, Linkedin, Mail, ExternalLink, Gamepad2, User, Code, Terminal } from 'lucide-react';
        ...
        {gameState === 'start' ? (
          ...
          >
            ...
            >
              ...
              <p className="text-sm md:text-lg text-gray-400 font-mono">16-BIT PORTFOLIO v1.0</p>
            </motion.div>
              ...
              {sections.map((s) => (
                <button
                  ...
                  className={`pixel-button flex items-center gap-2 text-[10px] md:text-xs ${
                    selectedSection === s.id ? 'bg-[#00ff41] text-black' : 'bg-black text-white'
                  }`}
                >
                  {s.icon}
                  {s.label}
                  ...
                  >
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                      ...
                      <div className="space-y-4 text-center md:text-left">
                        <h2 className="text-2xl text-[#00ff41]">WELCOME, PLAYER 1</h2>
                        <p className="text-sm leading-relaxed text-gray-300">
                          Gabriele Fontana is a developer exploring the digital frontier. 
                          Specializing in giving value to the system.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="pixel-box bg-[#111] border-gray-600">
                        <h3 className="text-xs mb-4 text-[#00ffff]">EQUIPMENT</h3>
                        <ul className="text-[10px] space-y-2 text-gray-400">
                          <li>VS CODE + VIM</li>
                          <li>GIT / GITHUB</li>
                          <li>DOCKER / KUBE</li>
                ...
                {selectedSection === 'about' && (
                  ...
                  >
                    ...
                    <p className="text-sm leading-loose text-gray-300">
                      Passionate about technology since the early days of computing. 
                      Gabriele focuses on creating clean, efficient, and secure applications. 
                      Always looking for the next challenge and learning new spells in the ever-evolving 
                ...
                {selectedSection === 'projects' && (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 gap-6">
                      {[
                        { title: 'GAFREAX REPO', desc: 'Main GitHub repository with various experiments.', link: 'https://github.com/gafreax' },
                        { title: 'CSS OPTIMIZER', desc: 'A powerful TypeScript library for optimizing CSS.', link: 'https://gafreax.github.io/csscrunch/' },
                      ].map((p, i) => (
                        <div key={i} className="pixel-box bg-[#1a1a1a] border-gray-700 hover:border-[#00ff41] transition-colors group">
                          <div className="flex justify-between items-start">
                            <h3 className="text-sm text-[#00ffff] group-hover:text-[#00ff41]">{p.title}</h3>
                            <a href={p.link} target="_blank" rel="noopener noreferrer">
                              <ExternalLink size={16} className="text-gray-500 hover:text-white" />
                            </a>
                          </div>
                          <p className="text-[10px] mt-2 text-gray-400">{p.desc}</p>
                        </div>
                      ))}
                    </div>
                  </motion.div>
